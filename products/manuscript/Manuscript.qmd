...
This study employs simulated data to assess the effectiveness of the EM algorithm. Following successful testing, the refined algorithm will be applied to actual sales data pertaining to luxury goods. 

## Questions/Hypotheses to be addressed
_State the research questions you plan to answer with this analysis._

This study aims to answer the question, "How effective is the Expectation Maximization (EM) algorithm in identifying distinct customer groups within luxury goods sales data when accounting for individual spending by each customer, as demonstrated by initial validation using simulated data?"
