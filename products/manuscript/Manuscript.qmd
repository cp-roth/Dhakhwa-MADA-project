...
@fig-result2 depicts two density plots for the Cumulative Sales and Invoice Values across customers and a histogram for Customer purchase frequencies. Both density plots are heavily right-skewed.The averages of total sales to a customer and total invoice values appear to be less than 2500 and 500 sterling pounds, respectively, supporting the mean values of 1532 and 436 in the descriptive table. The average frequency appears to be less than 5 times, which is also observed in the descriptive statistics table.
